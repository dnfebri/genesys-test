        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <div>
            <form action="{{ $metaData['url'] }}" method="post">
              ...
              <div>
                <label for="" class="block font-medium text-sm text-gray-700">Tambah Stock</label>
                <input value="" type="string" name="stock" id="stock" class="input input-bordered w-full max-w-xs border border-gray-500">
                @error('stock')
                <p class="text-red-500 text-xs">{{$message}}</p>
                @enderror
              </div>
