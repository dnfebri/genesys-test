...
--
-- Host: 127.0.0.1    Database: dnfebri_test
-- ------------------------------------------------------
...
CREATE TABLE `inventories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `fieldinventory_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin','admin@admin.com',NULL,'$2y$12$7YtsXvLy3BnQ0ynybD4couMyMCSAK8gtAQIT.T2Pe/QjMNr3y/SwC',NULL,NULL,NULL);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

--
-- Dumping routines for database 'dnfebri_test'
--
